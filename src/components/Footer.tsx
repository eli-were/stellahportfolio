          ...
          <div className="flex flex-col gap-4 max-w-xs">
            ...
            <div className="flex items-center gap-3 mt-1">
              <a
                ...
                aria-label="Email"
                className="w-11 h-11 rounded-full border border-border flex items-center justify-center hover:bg-primary hover:border-primary hover:text-primary-foreground transition-all duration-300 text-muted-foreground">
              ...
              <a
                ...
                aria-label="WhatsApp"
                className="w-11 h-11 rounded-full border border-border flex items-center justify-center hover:bg-[#25D366] hover:border-[#25D366] hover:text-white transition-all duration-300 text-muted-foreground">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-11 h-11 rounded-full border border-border flex items-center justify-center hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-white transition-all duration-300 text-muted-foreground">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-11 h-11 rounded-full border border-border flex items-center justify-center hover:bg-[#0A66C2] hover:border-[#0A66C2] hover:text-white transition-all duration-300 text-muted-foreground">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
